class Type{
    ...
    public static String getEspece(int numPokedex){
        String nomPokemon = new String(espece[numPokedex-1]);        //On fait -1 car le tableau commence a 0 et pas 1
    	return nomPokemon;
    }
    ...
    public static String getNomType(int type){
    	String nomType = new String(nomsType[type]);
    	return nomType;
    }
    ...
    public static double getEfficacite(int typeAtt, int typeDef){
    	double efficaciteAtk = efficacite[typeAtt][typeDef];
    	return efficaciteAtk;
    }
